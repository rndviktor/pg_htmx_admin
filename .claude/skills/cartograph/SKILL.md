...
- `docs/pgadmin4-feature-gap.md` compares this app against pgAdmin4 (P1–P5 by priority) and is the source of truth for what to build next (current suggested next step: #2 View/Edit Data editable grid).
